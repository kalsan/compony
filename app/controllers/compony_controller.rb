  ...
  Components.constants.each do |family_cst|
    Components.const_get(family_cst).constants.each do |comp_cst|
      ...
      comp.standalone_configs.each_value do |standalone_config|
        ...
        define_method(standalone_config.action_name) do
        ...
        actions_without_authentication << standalone_config.action_name.to_sym if standalone_config.skip_authentication
      end
    end
  end
