module Compony
  ...
  class RequestContext < Dslblend::Base
    ...
    def initialize(component, controller, *additional_providers, helpers: nil)
      ...
      super(helpers || controller.helpers, controller, *additional_providers, main_provider: component)
